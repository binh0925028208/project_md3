...
class OrderItemsRepository {
    ...
    createOrderItems(formRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield orderItems_entity_1.default.create(formRequest);
        });
    }
    deleteOrderItemsById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield orderItems_entity_1.default.destroy({
                where: {
                    id,
                },
            });
    ...
    updateOrderItems(id, formUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield orderItems_entity_1.default.update(formUpdate, {
                where: {
                    id,
                },
            });
...
exports.default = OrderItemsRepository;
